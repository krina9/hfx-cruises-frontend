...
export class CruiseCareersComponent implements OnInit {
	...
	jobDetails = [
		...
		},
		{
			...
			responsibility:
				'The organisation is looking for a Jr. Captain to oversee cruise operations on board, including maintaining staff and passenger safety while at sea. You should be able to delegate tasks to every cruise participant in attendance and ensure that everything runs smoothly.',
			qualification:
				'1.Minimum 5 years of experience,2.Able to communicate in multiple languages,3.Great understanding of the software system used in modern cruise,4.Leadership and fast decision making capabilities',
			perks: 'Excellent work-life balance, as well as housing assistance, company stock, and health insurance of 100,000 CDN that is redeemable at any time.After 15 years of service with our company, all of our employees are entitled to pensions.',
		},
		...
		},
		{
			...
			location: 'Halifax',
			type: 'Full Time',
			company_logo: '../../assets/images/Jack.jpg',
			...
			responsibility:
				'The organisation is looking for a crew to oversee cruise operations on board, including maintaining staff and passenger safety while at sea. You should be able to delegate tasks to every cruise participant in attendance and ensure that everything runs smoothly.',
			qualification:
				'1.Minimum 5 years of experience,2.Able to communicate in multiple languages,3.Great understanding of the software system used in modern cruise,4.Leadership and fast decision making capabilities',
			perks: 'Excellent work-life balance, as well as housing assistance, company stock, and health insurance of 100,000 CDN that is redeemable at any time.After 15 years of service with our company, all of our employees are entitled to pensions.',
		},
	...
	onSubmit() {
		...
		this.jobDetails = this.jobDetails.filter((item) => {
			if (
				(this.job != undefined && this.location != undefined) ||
				(this.job != '' && this.location != '')
			) {
				filterJobdetail =
